...
import { GithubWikiInputSchema, type GithubWikiInput, type WikiPage } from '../schemas/wiki.js';
 ...
 */
export async function handleWikiTool(input: GithubWikiInput): Promise<WikiToolResult> {
...
async function handleListWiki(input: GithubWikiInput): Promise<WikiToolResult> {
...
async function handleGetPage(input: GithubWikiInput): Promise<WikiToolResult> {
  if (!input.page) {
...
async function handleCreatePage(input: GithubWikiInput): Promise<WikiToolResult> {
...
async function handleUpdatePage(input: GithubWikiInput): Promise<WikiToolResult> {
  if (!input.page || !input.content) {
...
async function handleSearchWiki(input: GithubWikiInput): Promise<WikiToolResult> {
  if (!input.query) {
